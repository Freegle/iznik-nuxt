module.exports = {
  ...
  deploy: {
    ...
    production: {
      ...
      'post-deploy':
        'monit stop nginx && rsync -a app4:/var/build/iznik-nuxt/ . && rm -r .git* && cp restartfd /etc && chmod +x /etc/restartfd && cp waitfornode /etc && chmod +x /etc/waitfornode && pm2 restart FD-production --update-env && /etc/waitfornode && monit start nginx'
    },
    ...
    development: {
      ...
      'post-deploy':
        'rsync -a app4:/var/build/iznik-nuxt/ . && rm -r .git* && cp restartfd /etc && chmod +x /etc/restartfd && cp waitfornode /etc && chmod +x /etc/waitfornode && pm2 restart FD-development --update-env && /etc/waitfornode'
    },
    ...
    debug: {
      ...
      'post-deploy':
        'rsync -a app4:/var/build/iznik-nuxt/ . && rm -r .git* && cp restartfd /etc && chmod +x /etc/restartfd && cp waitfornode /etc && chmod +x /etc/waitfornode && pm2 restart FD-debug --update-env && /etc/waitfornode'
    }
  }
}
