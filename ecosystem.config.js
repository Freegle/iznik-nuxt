module.exports = {
  ...
  deploy: {
    ...
    production: {
      ...
      'post-deploy':
        'monit stop nginx && --exclude .git rsync -a app4:/var/build/iznik-nuxt/ . && npx patch-package && cp restartfd /etc && chmod +x /etc/restartfd && cp waitfornode /etc && chmod +x /etc/waitfornode && pm2 restart FD-production --update-env && /etc/waitfornode && monit start nginx'
    },
