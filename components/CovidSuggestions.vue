<template>
  <div>
    ...
    <div v-if="!busy && suggestedHelpers && suggestedHelpers.length">
      ...
      <div v-for="helper in suggestedHelpers" :key="'helper-' + helper.id">
    ...
    <NoticeMessage v-else variant="info">
      We're sorry, we don't have any suggestions for you yet.  Please check back later.
    </NoticeMessage>
    <p class="mt-2">
