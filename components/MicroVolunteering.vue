    ...
    <client-only>
      ...
      >
        ...
        <b-card-text>
          ...
          <p>
            It'll only take a few seconds, and you'll be helping out other people in the Freegle community.  Plus
        ...
        <b-card-text>
          ...
          <div v-if="task" :key="bump">
            ...
            <div v-else-if="task.type === 'SearchTerm'">
              ...
              <hr>
              <div class="d-flex flex-wrap justify-content-between">
                <b-btn variant="secondary" size="lg" class="mt-2" :disabled="similarTerms.length > 0" @click="considerNext">
