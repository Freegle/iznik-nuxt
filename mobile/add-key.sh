...
security import mobile/secrets/FreegleLtd-exp-2024-03-27.cer -k ~/Library/Keychains/ios-build.keychain -T /usr/bin/codesign -T /usr/bin/xcrun
security import mobile/secrets/FreegleLtd-exp-2024-03-27.p12 -k ~/Library/Keychains/ios-build.keychain -P $iossignkey -T /usr/bin/codesign -T /usr/bin/xcrun
