    ...
    <b-row class="m-0">
      ...
      <b-col cols="12" md="6">
            ...
            <b-tab active>
              ...
              <Question id="youcanhelp">
                ...
                <template slot="content">
                  ...
                  <p>
                    You can reach us at <ExternalLink href="mailto:volunteers@ilovefreegle.org">
                      volunteers@ilovefreegle.org
                    </ExternalLink>.
                  </p>
                  <p>
        ...
        <div class="text-muted">
          ...
          <ul>
            <li>
              Our support volunteers at <ExternalLink href="mailto:support@ilovefreegle.org">
            ...
            <li>
              Our national mailbox volunteers at <ExternalLink href="mailto:info@ilovefreegle.org">
                info@ilovefreegle.org
              </ExternalLink>. They
            ...
            <li>
              Our media volunteers at <ExternalLink href="mailto:media@ilovefreegle.org">
                media@ilovefreegle.org
              </ExternalLink>. Please use this if
