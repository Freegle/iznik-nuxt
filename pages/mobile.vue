  ...
  <b-row>
    ...
    <b-col cols="12" lg="6">
      <div class="text-center">
        ...
        <p>
          Freegling is easy on mobiles and tablets, and you get notifications of replies so you don't have to rely on email. Download using these links or search for Freegle in your app store - it's free!
        </p>
        <b-row>
          <b-col>
            <a href="https://play.google.com/store/apps/details?id=org.ilovefreegle.direct" class="mt-2" alt="Android app" target="_blank">
          ...
          <b-col>
            <a href="https://itunes.apple.com/gb/app/freegle/id970045029?ls=1&amp;mt=8" class="mt-2" alt="IOS app" target="_blank">
