      ...
      <b-card no-body variant="success">
        ...
        <b-card-text class="pl-2 pr-2">
          ...
          <p>
            ...
            <ExternalLink href="https://preprod.wrap.org.uk/sites/default/files/2020-09/WRAP-UK%20bulky%20waste%20summary_0.pdf">Research by WRAP</ExternalLink>
            in 2012 estimated that 42% of all bulky waste in the UK is furniture, 19% is textiles (such as mattresses) and 19% is large waste electrical and electronic equipment (WEEE).
          </p>
          <h3>
          ...
          <ul>
            <li>Creating a circular economy.</li>
            <li>Reducing waste & the associated collection / disposal costs for local authorities and residents.</li>
            <li>Encouraging sustainability.</li>
            <li>Protecting resources.</li>
            <li>Reducing consumption-based GHG emissions.<a href="#foot2"><sup>[2]</sup></a></li>
            <li>Reducing furniture poverty.<a href="#foot3"><sup>[3]</sup></a></li>
          </ul>
          <h3>
          ...
          <p>
            Freegle is a national online reuse platform and easy-to-use app. Freegle has been busy facilitating reuse
            in the community since 2009. Our network of local communities, run entirely by volunteers, help to make
            reuse simple and accessible to all. The best part about Freegle is that it is free to use and everything
            on Freegle, is free! <ExternalLink href="https://www.ilovefreegle.org">
